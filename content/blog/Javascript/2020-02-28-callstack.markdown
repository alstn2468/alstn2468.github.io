...
<img src="/assets/2020-02-26-CallStack/1.png" width="400"/><br>

`baz`함수가 호출되고 콜스택에 `baz`함수가 `push`된다.<br>

2. `bar`함수 호출

<img src="/assets/2020-02-26-CallStack/2.png" width="400"/><br>

`bar`함수가 호출되고 콜스택에 `bar`함수가 `push`된다.<br>

3. `foo`함수 호출

<img src="/assets/2020-02-26-CallStack/3.png" width="400"/><br>

`foo`함수가 호출되고 콜스택에 `foo`함수가 `push`된다.<br>

4. 최종 콜스택

<img src="/assets/2020-02-26-CallStack/4.png" width="400"/><br>
...
<img src="/assets/2020-02-26-CallStack/5.png" width="400"/><br>

`baz`, `bar`, `foo`함수가 순서대로 호출되는 것을 확인할 수 있다.<br>
`Error`가 던져진 이후의 아래의 로그를 보면 콜스택(`Call Stack`)을 확인할 수 있다.<br>

<img src="/assets/2020-02-26-CallStack/6.png" width="600"/><br>
...
<img src="/assets/2020-02-26-CallStack/7.png" width="600"/><br>

**Maximum call stack size exceeded**와 같이 콜스택 사이즈가 초과되었다는 오류를 볼 수 있다.<br>

<img src="/assets/2020-02-26-CallStack/8.png" width="500"/><br>
...
<img src="/assets/2020-02-26-CallStack/9.png" width="400"/><br>
...
<img src="/assets/2020-02-26-CallStack/11.png" width="700"/><br>

따라서 `console.log("Second Log");`가 **콜스택**에 삽입 된다.<br>

<img src="/assets/2020-02-26-CallStack/12.png" width="700"/><br>

**콜스택**에 있는 모든 함수 실행이 끝나고 삭제되어 **콜스택**이 비어있게 된다.<br>

<img src="/assets/2020-02-26-CallStack/13.png" width="700"/><br>
