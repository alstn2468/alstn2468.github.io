...
<img src="./images/2020-06-01/1.PNG" width="700" height="auto">

- 유효한 토큰일 경우 (**200 OK**)

<img src="./images/2020-06-01/2.PNG" width="700" height="auto">

- 만료된 토큰일 경우 (**403 FORBIDDEN**)

<img src="./images/2020-06-01/3.png" width="700" height="auto">
...
이어지는 포스트에서는 **JWT**를 이용한 로그인을 구현해보도록 하겠다.
